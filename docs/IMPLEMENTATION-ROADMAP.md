...
already implemented and are not counted in this implementation queue.

| Rank | Canonical page                  | Dependencies                                                                         | Reusable pattern established                                                   | Important scope caveat                                                                                     | Prerequisite redirects                                                     |
| ---: | ------------------------------- | ------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------ | ---------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------- |
|    1 | `/government/offices`           | Public 22-office export and `civic/government.ts`                                    | Searchable directory, verified-contact fields, source and last-checked labels  | The export is bounded; do not claim it contains every city unit or person-level directory                  | `/government/directory`, `/government/contacts`, `/government/departments` |
|    2 | `/legislation/executive-orders` | Public 11-record EO export and typed legislation access                              | Record collection, evidence authority, full-text availability, coverage notice | Captured official archive, not complete history; three older references remain in recovery                 | None                                                                       |
|    3 | `/projects/map`                 | 239 projects, barangay associations where available, and 35 barangay polygons        | Polygon choropleth, aggregation, null-barangay handling, bounded-map legend    | Barangay distribution only; there are no verified project point locations and no centroids may be invented | None                                                                       |
|    4 | `/statistics/projects`          | Public project export and lifecycle semantics                                        | Coverage-aware metric cards, distributions, denominators, as-of labeling       | Bounded infrastructure/public-works subset; lifecycle evidence is not physical progress                    | `/projects/dashboard`                                                      |
|    5 | `/statistics/population`        | PSA 2024 POPCEN export and 35 barangay records                                       | Sourced totals, comparisons, charts, polygon/table coordination                | Use the single 2024 baseline and total of 377,534; do not silently mix periods                             | `/statistics/population/barangays`                                         |
|    6 | `/barangays`                    | Demographics export, PSGC identity, and barangay GeoJSON                             | Barangay directory, classification filters, boundary-linked summaries          | No named secretaries, BHERT contacts, or project points are publication-approved                           | None                                                                       |
