...
The next three items are numbered by immediate execution order. The remaining
...
| --------------------: | --------------------------- | ------------------------------------------------------------------------------------ | ------------------------------------------------------------------------- | --------------------------------------------------------------------------------------- | --------------------------------------------------------- |
|                     1 | `/statistics/projects`      | Public project export and lifecycle semantics                                        | Coverage-aware metric cards, distributions, denominators, as-of labeling  | Bounded infrastructure/public-works subset; lifecycle evidence is not physical progress | `/projects/dashboard`                                     |
|                     2 | `/statistics/population`    | PSA 2024 POPCEN export and 35 barangay records                                       | Sourced totals, comparisons, charts, polygon/table coordination           | Use the single 2024 baseline and total of 377,534; do not silently mix periods          | `/statistics/population/barangays`                        |
|                     3 | `/barangays`                | Demographics export, PSGC identity, and barangay GeoJSON                             | Barangay directory, classification filters, boundary-linked summaries     | No named secretaries, BHERT contacts, or project points are publication-approved        | None                                                      |
