...
reported to the project maintainers via a private report on the repository
(for example, GitHub's report/abuse tooling on the relevant issue, PR, or
user profile). All complaints will be reviewed and investigated promptly and
fairly.
