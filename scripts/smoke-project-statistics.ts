...
assert.equal(statistics.barangayAttribution.attributed, 299);
...
assert.deepEqual(
  ...
  [
    ['approved_budget_abc', 228, 96],
    ['winning_bid_amount', 231, 93],
    ['contract_amount', 8, 316],
  ]
);
