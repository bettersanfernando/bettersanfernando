      ...
      {latestCostUtilizationObservation && (
        <div className="mb-8">
          ...
          <Text className="text-gray-600 mb-4 text-sm">
            A verified, source-reported cost-utilization observation exists for
            this project.{' '}
            <Link
          ...
          <Card>
            <CardContent>
              ...
              <p className="text-xs text-gray-500 mt-5 pt-4 border-t border-gray-200">
                ...
                proof of cash payment or disbursement. Currency is not stated in
                the source; amounts are shown as plain numbers. Coverage is
