...
// interactive piece — the search form — is extracted into
// home-search-form.next.tsx so this page itself stays a Server Component.
    ...
    <main className="flex-grow bg-gray-50">
        ...
        <div className="container mx-auto grid gap-10 px-4 py-12 lg:grid-cols-[minmax(0,1fr)_minmax(20rem,0.72fr)] lg:items-end md:py-16">
          <header className="max-w-3xl">
            ...
            <p className="mt-5 max-w-[66ch] text-lg leading-8 text-gray-700">
              ...
              public information about the City of San Fernando, Pampanga easier
              to find, understand, and trace back to sources.
            </p>
      ...
      <section className="border-y border-gray-200 bg-white">
        <div className="container mx-auto px-4 py-10 md:py-14">
          <div className="max-w-3xl">
            ...
            <p className="mt-2 text-sm leading-6 text-gray-700">
              Enter through the section that best matches the public information
              you need.
            </p>
          </div>
        ...
        <div className="container mx-auto grid gap-10 px-4 py-10 lg:grid-cols-2 lg:gap-16 md:py-14">
          <div>
            ...
            <p className="mt-3 max-w-[68ch] text-sm leading-6 text-gray-700">
              Browse {summary.government.officeRecords} published office records
              and currently available institutional contact details. These
              records are not asserted to represent the complete City
          ...
          <div>
            <FileText className="h-7 w-7 text-primary-700" aria-hidden="true" />
            <h2 className="mt-4 text-2xl font-bold text-gray-900">
              Legislation
            </h2>
            <p className="mt-3 max-w-[68ch] text-sm leading-6 text-gray-700">
      ...
      <section className="container mx-auto px-4 py-10 md:py-14">
        <div className="grid gap-8 lg:grid-cols-[15rem_minmax(0,48rem)] lg:gap-14">
          <div>
            <Database className="h-7 w-7 text-primary-700" aria-hidden="true" />
            <h2 className="mt-4 text-2xl font-bold text-gray-900 md:text-3xl">
          ...
          <div>
            ...
            <p className="mt-6 text-sm leading-6 text-gray-700">
              ...
              bounded datasets labeled, does not treat missing data as zero, and
              does not silently fill gaps. Only reviewed frontend-safe
