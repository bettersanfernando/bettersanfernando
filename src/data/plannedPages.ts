const plannedPageRoutes = [
  ...
  { id: 'governmentOffices', path: '/government/offices' },
  { id: 'governmentDirectory', path: '/government/directory' },
  { id: 'governmentContacts', path: '/government/contacts' },
  { id: 'legislation', path: '/legislation' },
  { id: 'executiveOrders', path: '/legislation/executive-orders' },
  ...
  { id: 'projectStatistics', path: '/statistics/projects' },
