...
export default function Services() {
  ...
  return (
    <>
      <SEO
        title="Services"
        description="Selected Business License and Permit Division services published from the City of San Fernando Citizen's Charter."
        keywords="business permits, business licenses, BLPD, San Fernando Pampanga services"
      />
            ...
            <div className="grid items-end gap-8 lg:grid-cols-[minmax(0,1fr)_22rem]">
              <div className="max-w-3xl">
                ...
                <p className="mt-4 max-w-2xl text-base leading-relaxed text-gray-700 md:text-lg">
                  ...
                  steps for currently published Business License and Permit
                  Division services.
                </p>
              </div>
              <aside className="rounded-xl bg-primary-50 p-5 text-sm leading-6 text-primary-900">
                ...
                <p className="mt-1">
                  Currently available: selected Business License and Permit
                  Division services. This is not a complete directory of all
            ...
            <dl className="mt-9 border-y border-gray-200 py-5">
              <div className="flex flex-wrap items-baseline gap-x-3 gap-y-1">
                ...
                <dd className="text-sm font-semibold text-gray-700">
                  Business License and Permit Division (BLPD)
                </dd>
              </div>
            </dl>
          </div>
